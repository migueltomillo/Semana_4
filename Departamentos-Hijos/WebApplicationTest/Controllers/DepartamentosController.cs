...
namespace WebApplicationTest.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            var totalEmpleadosPrimerDepartamento = departamentos[0].Empleados.Count();

            var departamentosOtros = _context
                .Departamentos
                .Include(x => x.Empleados)
                .Where(z=>z.Nombre == "Tecnologia")
                .Where(z=>z.DepartamentoId > 1)
                .Select(x => new { Id = x.DepartamentoId, Name = x.Nombre, TotalEmpleados = 0 })
                .ToList();

            var id = departamentosOtros[0].Id;
            var name = departamentosOtros[0].Name;
            var total = departamentosOtros[0].TotalEmpleados;
            //¿Que expresion de linq to sql se debe usarse para reemplazar el 0 por el numero  de empleados?
            //pista => SelecMany
            return View();
        }
