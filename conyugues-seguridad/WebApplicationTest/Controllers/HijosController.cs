...
namespace WebApplicationTest.Controllers
{
    ...
    public class HijosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HijoId,Nombre,Apellido")] Hijo hijo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HijoId,Nombre,Apellido")] Hijo hijo)
        {
            if (id != hijo.HijoId)
            {
                return NotFound();
